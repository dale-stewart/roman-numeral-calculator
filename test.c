...
START_TEST(argument_too_large_returns_empty_string)
{
    ...
    ASSERT_ROMAN_ADD_EQ("", "MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM", "");
    ASSERT_ROMAN_SUBTRACT_EQ("MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM", "", "");
    ASSERT_ROMAN_SUBTRACT_EQ("", "MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM", "");
}
END_TEST
...
{
    ASSERT_ROMAN_ADD_EQ("MMMMMMMMMMMMMMMMMMMMMMMMMMMMIV", "", "");
    ASSERT_ROMAN_SUBTRACT_EQ("MMMMMMMMMMMMMMMMMMMMMMMMMMMMIV", "", "");
    ASSERT_ROMAN_ADD_EQ("", "MMMMMMMMMMMMMMMMMMMMMMMMMMMMIV", "");
    ASSERT_ROMAN_SUBTRACT_EQ("", "MMMMMMMMMMMMMMMMMMMMMMMMMMMMIV", "");
}
END_TEST
